...
class Datepicker extends Component {
    ...
    init() {
        ...
        let config = {
            ...
            isEmptyClass: this._config.emptyClass,
            isDisabledClass: this._config.disabledClass,
            isOutsideMonthClass: this._config.otherDaysClass,
            isSelectionDisabledClass: this._config.otherDaysDisabledClass,
            hasEventClass: this._config.eventClass,
            isInRangeClass: this._config.rangeClass,
            isStartRangeClass: this._config.rangeStartClass,
            isEndRangeClass: this._config.rangeEndClass,
            i18n: {
